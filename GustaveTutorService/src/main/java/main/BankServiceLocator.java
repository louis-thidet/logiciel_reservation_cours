...
public class BankServiceLocator extends org.apache.axis.client.Service implements main.BankService {
    ...
    public main.Bank getBank(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.BankSoapBindingStub _stub = new main.BankSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.Bank.class.isAssignableFrom(serviceEndpointInterface)) {
                main.BankSoapBindingStub _stub = new main.BankSoapBindingStub(new java.net.URL(Bank_address), this);
                _stub.setPortName(getBankWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://main", "BankService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://main", "Bank"));
        }
